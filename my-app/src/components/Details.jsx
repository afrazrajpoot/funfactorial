    ...
    <>
      <div className="w-full max-w-[100vw]">
        ...
        <p className="font-medium w-[100vw] text-[3vw] text-center lg:text-left lg:w-full lg:max-w-[50vw] lg:text-[1vw] mt-[3vw] lg:mt-[1vw] font-ab">
          ...
          Based in Leeds, our company aims for total customer satisfaction. It
          is our objective to make sure all our inflatables, as well as our
        ...
        <p className="lg:text-[1vw] w-[100vw] text-center lg:text-left text-[3vw] lg:w-full lg:max-w-[60vw]   lg:mt-[1vw] mt-[3vw] font-ab">
          ...
          performance and proves very popular with the kids! Please do read
          through the Terms where you will find details of our Public Liability
          insurance as well as the terms for hire. We are extremely confident
