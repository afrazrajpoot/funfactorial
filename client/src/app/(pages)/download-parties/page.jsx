...
import { DownloadPartiesData } from "@/app/data";
import Link from "next/link";
import dynamic from "next/dynamic";

// Dynamically import Header with ssr: false to ensure client-side rendering
  ...
  <Header />
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {DownloadPartiesData && DownloadPartiesData.length > 0 && DownloadPartiesData?.map((elem, ind) => (
            <div 
              key={ind}
