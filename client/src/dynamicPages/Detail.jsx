...
const Detail = () => {
  ...
  const buttons = [
    { name: "Long description", icon: <FaInfoCircle /> },
  ...
  <div className="bg-gray-100 p-[3vw] rounded-lg shadow-lg" >
    ...
    <p className="text-[2.5vw] md:text-[1vw] mt-[1.5vw]">
  ...
  <div className="bg-gray-100 p-[3vw] rounded-lg shadow-lg">
    ...
    <p className="text-[2.5vw] md:text-[1vw] mt-[1.5vw] text-gray-600">
      {productData?.longDescription1}
    </p>
  </div>
